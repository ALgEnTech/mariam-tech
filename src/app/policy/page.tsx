        ...
        <div className="md:grid md:grid-cols-4 md:gap-8">
          ...
          >
            <div className="p-4 rounded-lg bg-neutral-900/40 border border-neutral-800">
              ...
              <ul className="space-y-2 text-gray-300 text-sm">
                <li>
                  <a href="#transparency" className="hover:underline">
                    Transparency
                  </a>
                </li>
                <li>
                  <a href="#responsible-use" className="hover:underline">
                    Responsible use
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#oversight" className="hover:underline">
          ...
          <div className="col-span-3">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-2 text-xs text-gray-200">
                    <li className="bg-neutral-800/40 px-3 py-2 rounded-md">
            ...
            <Section id="transparency" title="Transparency">
              ...
              <ul>
                <li>
                  <strong>Chat / assistant replies:</strong> identified as “AI
                  generated” when the content was created or significantly
                  shaped by an AI.
                </li>
                <li>
                  <strong>Summaries / drafts:</strong> annotated with source
                  links or references where feasible.
                </li>
                <li>
                  <strong>Third-party models:</strong> we disclose when a
                  third-party model is used and provide its general provenance.
                </li>
              </ul>
            </Section>
            ...
            <Section id="privacy" title="Privacy & data handling">
              ...
              <ul>
                <li>
                  <strong>Purpose limitation:</strong> only collect data
                  necessary to provide the contracted service.
                </li>
                <li>
                  <strong>Consent & control:</strong> clients can opt in/out of
                  model fine-tuning or internal analytics.
                </li>
                <li>
                  <strong>Anonymization:</strong> pseudonymize/anonymize data
                  before analysis or training where required.
                </li>
              </ul>
            </Section>
            ...
            <Section id="oversight" title="Human oversight & limitations">
              <p>
                AI helps with drafting, triage, and automation but is not
                infallible. We therefore:
              </p>
              <ul>
                <li>
                  <strong>Human-in-the-loop:</strong> critical decisions (legal,
                  medical, financial) are reviewed by humans.
                </li>
                <li>
                  <strong>Known limitations:</strong> models can hallucinate or
                  reflect training gaps; we advise validation steps.
                </li>
                <li>
                  <strong>Error reporting:</strong> clients can report issues and
                  request investigations or rollbacks.
                </li>
              </ul>
            </Section>
            ...
            <Section id="security" title="Security & retention">
              <p>
                Security controls include encryption in transit/at rest,
                role-based access, and contract-defined retention with
            ...
            <Section id="requests" title="Client requests & contact">
              ...
              <ul>
                <li>
                  <strong>Request export/delete:</strong>{" "}
                  <a
                    className="underline hover:text-indigo-300"
                    href="mailto:privacy@yourdomain.com?subject=Data%20Request"
                  >
                ...
                <li>
                  <strong>Permission to publish:</strong> we don’t publish
                  client logos/names/metrics without explicit written permission.
                </li>
                <li>
                  <strong>Report an issue:</strong>{" "}
                  <a
                    className="underline hover:text-indigo-300"
                    href="mailto:hello@yourdomain.com?subject=AI%20Issue"
                  >
            ...
            <Section id="changelog" title="Change log">
              <p className="text-sm text-gray-400 mb-2">
                Small, transparent record of policy changes.
              </p>
              <ul className="text-sm text-gray-300 space-y-2">
                <li>
                  <strong>2025-09-01</strong> — Clarified consent language for
                  training data and added explicit contact points for data
                  requests.
                </li>
                <li>
                  <strong>2024-12-15</strong> — Added section on human oversight
                  and bias testing cadence.
                </li>
              </ul>
            </Section>
            {/* Bottom CTA intentionally removed */}
          </div>
        </div>
      </div>
    </main>
