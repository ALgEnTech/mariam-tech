        ...
        <div className="md:grid md:grid-cols-4 md:gap-8">
          ...
          <div className="col-span-3">
            ...
            <Section id="transparency" title="Transparency">
              <p>
                When Mariam Tech delivers AI-driven features (chatbots, document assistants, automation),
                we clearly label AI-generated content and make best-effort citations or references where applicable.
                We aim to let users know when a response, summary, or draft was produced by a model rather than a human.
              </p>
              <h3 className="text-base font-medium mt-4">What we label</h3>
              <ul>
                <li><strong>Chat / assistant replies:</strong> identified as “AI generated” when the content was created or significantly shaped by an AI.</li>
                <li><strong>Summaries / drafts:</strong> annotated with source links or references where feasible.</li>
                <li><strong>Third-party models:</strong> we disclose when a third-party model is used and provide its general provenance.</li>
              </ul>
            </Section>

            <Section id="responsible-use" title="Responsible use">
              <p>
                We design and tune AI systems to reduce harmful outcomes and limit bias. Practices include guardrails,
                periodic bias tests, and avoiding misleading guarantees about business outcomes.
              </p>
            </Section>

            <Section id="privacy" title="Privacy & data handling">
              <p>Client and user data are treated as confidential. We adhere to the following principles:</p>
              <ul>
                <li><strong>Purpose limitation:</strong> only collect data necessary to provide the contracted service.</li>
                <li><strong>Consent & control:</strong> clients can opt in/out of model fine-tuning or internal analytics.</li>
                <li><strong>Anonymization:</strong> pseudonymize/anonymize data before analysis or training where required.</li>
              </ul>
            </Section>
            ...
            <Section id="oversight" title="Human oversight & limitations">
              ...
              <ul>
                ...
                <li><strong>Known limitations:</strong> models can hallucinate or reflect training gaps; we advise validation steps.</li>
                <li><strong>Error reporting:</strong> clients can report issues and request investigations or rollbacks.</li>
              </ul>
            </Section>

            <Section id="security" title="Security & retention">
              <p>Security controls include encryption in transit/at rest, role-based access, and contract-defined retention with delete/export on request.</p>
            </Section>

            <Section id="requests" title="Client requests & contact">
              <p>Clients can manage data and disclosures:</p>
              <ul>
                <li><strong>Request export/delete:</strong> email <a className="underline hover:text-indigo-300" href="mailto:privacy@yourdomain.com?subject=Data%20Request">privacy@yourdomain.com</a>.</li>
                <li><strong>Permission to publish:</strong> we don’t publish client logos/names/metrics without explicit written permission.</li>
                <li><strong>Report an issue:</strong> email <a className="underline hover:text-indigo-300" href="mailto:hello@yourdomain.com?subject=AI%20Issue">hello@yourdomain.com</a>.</li>
              </ul>
            </Section>

            <Section id="changelog" title="Change log">
              <p className="text-sm text-gray-400 mb-2">Small, transparent record of policy changes.</p>
              <ul className="text-sm text-gray-300 space-y-2">
                <li><strong>2025-09-01</strong> — Clarified consent language for training data and added explicit contact points for data requests.</li>
