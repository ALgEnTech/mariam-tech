...
const personas: Persona[] = [
  ...
  },
  {
    ...
    toolkit: ["Catalog writers", "Ad and UGC script studio", "Support macro studio"],
    tracks: [
  ...
  },
  {
    ...
    toolkit: ["Risk and compliance prompt sets", "Disclosure generators", "Portfolio and summary writers"],
    tracks: [
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 mt-16">
        ...
        <p className="mt-3 text-center text-brand-100">Short, focused modules. Build real workflows as you learn.</p>
